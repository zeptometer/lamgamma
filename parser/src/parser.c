...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 7, 0, 9),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lambda, 7, 0, 9),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice, 3, 0, 3),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice, 3, 0, 3),
  ...
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_type, 3, 0, 7),
  [286] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_type, 3, 0, 7),
  [288] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param, 3, 0, 5),
