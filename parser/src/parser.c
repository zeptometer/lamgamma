...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [125] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_div, 3, 0, 4),
  [127] = {.entry = {.count = 1, .reusable = false}}, SHIFT(47),
  [129] = {.entry = {.count = 1, .reusable = true}}, SHIFT(5),
  [131] = {.entry = {.count = 1, .reusable = true}}, SHIFT(47),
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_div, 3, 0, 4),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mod, 3, 0, 4),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mod, 3, 0, 4),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_eq, 3, 0, 4),
  ...
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_eq, 3, 0, 4),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ne, 3, 0, 4),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ne, 3, 0, 4),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lt, 3, 0, 4),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lt, 3, 0, 4),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_le, 3, 0, 4),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_le, 3, 0, 4),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gt, 3, 0, 4),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_gt, 3, 0, 4),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ge, 3, 0, 4),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ge, 3, 0, 4),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_and, 3, 0, 4),
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_and, 3, 0, 4),
  ...
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_or, 3, 0, 4),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_or, 3, 0, 4),
  ...
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ctrl_if, 6, 0, 8),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ctrl_if, 6, 0, 8),
  [211] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 6, 0, 9),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let, 6, 0, 9),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mult, 3, 0, 4),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mult, 3, 0, 4),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quote, 3, 0, 0),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quote, 3, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 9, 0, 11),
  [227] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lambda, 9, 0, 11),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean, 1, 0, 0),
  [231] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean, 1, 0, 0),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_application, 2, 0, 2),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_application, 2, 0, 2),
  ...
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice, 5, 0, 6),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice, 5, 0, 6),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice, 3, 0, 3),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice, 3, 0, 3),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 7, 0, 10),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lambda, 7, 0, 10),
  ...
  [277] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__simple_expression, 1, 0, 0), REDUCE(sym_param, 1, 0, 1),
  [280] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [282] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param, 1, 0, 1),
  ...
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func_type, 3, 0, 7),
  [296] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func_type, 3, 0, 7),
  [298] = {.entry = {.count = 1, .reusable = true}}, SHIFT(66),
  [300] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__type, 3, 0, 0),
  [302] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__type, 3, 0, 0),
  [304] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param, 3, 0, 5),
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_params_repeat1, 2, 0, 0),
  [308] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_params_repeat1, 2, 0, 0), SHIFT_REPEAT(79),
  [311] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_params, 2, 0, 0),
  [313] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_params, 1, 0, 0),
