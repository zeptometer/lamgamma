...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_and, 3, 0, 2),
  ...
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_and, 3, 0, 2),
  ...
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 3, 0, 2),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sub, 3, 0, 2),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mult, 3, 0, 2),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mult, 3, 0, 2),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_div, 3, 0, 2),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_div, 3, 0, 2),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mod, 3, 0, 2),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mod, 3, 0, 2),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_eq, 3, 0, 2),
  [175] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_eq, 3, 0, 2),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ne, 3, 0, 2),
  [179] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ne, 3, 0, 2),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lt, 3, 0, 2),
  [183] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lt, 3, 0, 2),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_le, 3, 0, 2),
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_le, 3, 0, 2),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gt, 3, 0, 2),
  [191] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_gt, 3, 0, 2),
  [193] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ge, 3, 0, 2),
  [195] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ge, 3, 0, 2),
  [197] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 6, 0, 0),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let, 6, 0, 0),
  [201] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [203] = {.entry = {.count = 1, .reusable = true}}, SHIFT(19),
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_or, 3, 0, 2),
  [207] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_or, 3, 0, 2),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 4, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lambda, 4, 0, 0),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fixpoint, 4, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fixpoint, 4, 0, 0),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_neg, 2, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_neg, 2, 0, 0),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_add, 3, 0, 2),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_add, 3, 0, 2),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ctrl_if, 6, 0, 4),
  [227] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ctrl_if, 6, 0, 4),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice, 5, 0, 3),
  [231] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice, 5, 0, 3),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean, 1, 0, 0),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean, 1, 0, 0),
  [237] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_application, 2, 0, 0),
  [239] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_application, 2, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__simple_expression, 3, 0, 0),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__simple_expression, 3, 0, 0),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quote, 3, 0, 0),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quote, 3, 0, 0),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice, 3, 0, 1),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice, 3, 0, 1),
  ...
  [273] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(60),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0),
