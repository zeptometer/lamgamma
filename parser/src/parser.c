...
enum ts_symbol_identifiers {
  ...
  anon_sym_BANG = 26,
  anon_sym_BQUOTE_LBRACE = 27,
  anon_sym_RBRACE = 28,
  anon_sym_TILDE_LBRACE = 29,
  anon_sym_TILDE = 30,
  anon_sym_LBRACE = 31,
  anon_sym_COLON = 32,
  anon_sym_let = 33,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (('_' <= lookahead && lookahead <= 'z')) ADVANCE(13);
      END_STATE();
    case 1:
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [anon_sym_BQUOTE_LBRACE] = ACTIONS(19),
    [anon_sym_TILDE_LBRACE] = ACTIONS(21),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ge, 3, 0, 2),
  ...
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ge, 3, 0, 2),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 6, 0, 0),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_let, 6, 0, 0),
  ...
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_add, 3, 0, 2),
  [171] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_add, 3, 0, 2),
  ...
  [205] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_and, 3, 0, 2),
  [207] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_and, 3, 0, 2),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_or, 3, 0, 2),
  [211] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_or, 3, 0, 2),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 4, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lambda, 4, 0, 0),
  [217] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fixpoint, 4, 0, 0),
  [219] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fixpoint, 4, 0, 0),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ctrl_if, 6, 0, 4),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ctrl_if, 6, 0, 4),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 3, 0, 2),
  [227] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sub, 3, 0, 2),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_application, 2, 0, 0),
  [231] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_application, 2, 0, 0),
  [233] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quote, 3, 0, 0),
  [235] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quote, 3, 0, 0),
  ...
  [241] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice, 3, 0, 1),
  [243] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice, 3, 0, 1),
  [245] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean, 1, 0, 0),
  [247] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean, 1, 0, 0),
  [249] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice, 5, 0, 3),
  [251] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice, 5, 0, 3),
  ...
  [271] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(60),
  ...
  [284] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_param, 1, 0, 0),
