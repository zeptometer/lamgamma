...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_le, 3, 0, 2),
  ...
  [133] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_le, 3, 0, 2),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ctrl_if, 6, 0, 4),
  [137] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ctrl_if, 6, 0, 4),
  ...
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_neg, 2, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_neg, 2, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_add, 3, 0, 2),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_add, 3, 0, 2),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 3, 0, 2),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_sub, 3, 0, 2),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mult, 3, 0, 2),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mult, 3, 0, 2),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_div, 3, 0, 2),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_div, 3, 0, 2),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_mod, 3, 0, 2),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_mod, 3, 0, 2),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_eq, 3, 0, 2),
  [181] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_eq, 3, 0, 2),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ne, 3, 0, 2),
  [185] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ne, 3, 0, 2),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lt, 3, 0, 2),
  [189] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lt, 3, 0, 2),
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_gt, 3, 0, 2),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_gt, 3, 0, 2),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ge, 3, 0, 2),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ge, 3, 0, 2),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_and, 3, 0, 2),
  [201] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_and, 3, 0, 2),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_or, 3, 0, 2),
  [205] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_or, 3, 0, 2),
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 4, 0, 0),
  [209] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_lambda, 4, 0, 0),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fixpoint, 4, 0, 0),
  [213] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fixpoint, 4, 0, 0),
  [215] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice, 3, 0, 1),
  [217] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice, 3, 0, 1),
  [219] = {.entry = {.count = 1, .reusable = false}}, SHIFT(23),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_application, 2, 0, 0),
  [223] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_application, 2, 0, 0),
  [225] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [227] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__simple_expression, 3, 0, 0),
  [229] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__simple_expression, 3, 0, 0),
  ...
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_quote, 3, 0, 0),
  [241] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_quote, 3, 0, 0),
  [243] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [245] = {.entry = {.count = 1, .reusable = false}}, SHIFT(3),
  [247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_splice, 5, 0, 3),
  [249] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_splice, 5, 0, 3),
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1, 0, 0),
  [253] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 1, 0, 0),
  [257] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [259] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(57),
